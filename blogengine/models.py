...
class Post(models.Model):
    ...
    #main_image_alt = models.CharField(max_length=50, help_text="Image description tag") 
    og_image = models.URLField(help_text="Image for Facebook OpenGraph; Min 200x200", blank=True, max_length=128)
    #og_image_alt = models.CharField(max_length=50, help_text="Image description tag") 
